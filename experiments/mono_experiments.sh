...
python3 ../train.py --model_name M_640x192_no_pt \
  --weights_init scratch \
  --num_epochs 30

# Baseline mono model, i.e. ours with our contributions turned off
python3 ../train.py --model_name M_640x192_baseline \
  --v1_multiscale --disable_automasking --avg_reprojection

# Mono without full-res multiscale
python3 ../train.py --model_name M_640x192_no_full_res_ms \
  --v1_multiscale

# Mono without automasking
python3 ../train.py --model_name M_640x192_no_automasking \
  --disable_automasking

# Mono without min reproj
python3 ../train.py --model_name M_640x192_no_min_reproj \
  --avg_reprojection

# Mono with Zhou's masking scheme instead of ours
python3 ../train.py --model_name M_640x192_zhou_masking \
